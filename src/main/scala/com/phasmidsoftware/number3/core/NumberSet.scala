...
case object C extends NumberSet {
  ...
  def belongsToSetExclusively(x: NumberLike): Boolean = ??? // TODO
}
...
case object Q extends NumberSet {
  ...
  def belongsToSetExclusively(x: NumberLike): Boolean = x.isInstanceOf[RationalNumber]
}
...
case object Z extends NumberSet {
  ...
  def belongsToSetExclusively(x: NumberLike): Boolean = false // TODO
}
